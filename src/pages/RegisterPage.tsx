          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Google Maps or Apple Maps pin URL"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Tuesdays at 10 AM"
                className="w-full px-4 py-2.5 rounded-lg border border-[#e5e7eb] text-sm focus:outline-none focus:ring-2 focus:ring-[#16a34a]/20 focus:border-[#16a34a]"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-[#16a34a] text-white rounded-lg font-medium hover:bg-[#15803d] transition-colors mt-2"
            >
              Register
            </button>
          </div>
